            ...
            <nav class="border-b border-gray-100 bg-white">
                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="dashboardUrl" :active="isDashboardActive">
                                    Dashboard
                                </NavLink>
                            </div>
                        </div>
                        ...
                        <div class="hidden sm:ms-6 sm:flex sm:items-center">
                            <div class="relative ms-3" v-if="user">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        <DropdownLink :href="profileUrl"> Profile </DropdownLink>
                                        <DropdownLink :href="logoutUrl" method="post" as="button"> Log Out
                                        </DropdownLink>
                                    </template>
                                </Dropdown>
                            </div>
                ...
                <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }"
                    ...
                    <div class="space-y-1 pb-3 pt-2">
                        <ResponsiveNavLink :href="dashboardUrl" :active="isDashboardActive"> Dashboard
                        </ResponsiveNavLink>
                    </div>
                    ...
                    <div class="border-t border-gray-200 pb-1 pt-4" v-if="user">
                        ...
                        <div class="mt-3 space-y-1">
                            <ResponsiveNavLink :href="profileUrl"> Profile </ResponsiveNavLink>
                            <ResponsiveNavLink :href="logoutUrl" method="post" as="button"> Log Out </ResponsiveNavLink>
                        </div>
                    </div>
                </div>
            </nav>
